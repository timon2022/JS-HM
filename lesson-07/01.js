...
const WEB_TECH_IMAGES = [
  ...
  'https://production-it-incubator.s3.eu-central-1.amazonaws.com/file-manager/Image/784380b9-6937-42a6-bdfe-869835820234_html-magic-logo.jpg',
      ...
      let tmp=0
      let btnPrev=document.getElementById('prev-button').addEventListener('click',()=>{
        document.querySelector('#web-tech-image').src=WEB_TECH_IMAGES[--tmp<0?tmp=2:tmp]
      })
      let btnNext=document.getElementById('next-button').addEventListener('click',()=>{
        document.querySelector('#web-tech-image').src=WEB_TECH_IMAGES[++tmp>=3?tmp=0:tmp]
      })